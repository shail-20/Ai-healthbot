...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblQuestion=Label(self,text="Question",width=12,bg="dark gray",fg="white")
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=12,bg="dark gray",fg="white")
        self.lblDigonosis.grid(row=4, column=0,sticky="n",pady=5)

        # self.varQuestion=StringVar()
        self.txtQuestion = Text(self, width=100,height=4, bg="black", fg="white")
        self.txtQuestion.grid(row=0, column=1,rowspan=4,columnspan=20)

        self.varDiagonosis=StringVar()
        self.txtDigonosis =Text(self, width=100,height=14, bg="black", fg="white")
        self.txtDigonosis.grid(row=4, column=1,columnspan=20,rowspan=20,pady=5)

        self.btnNo=Button(self,text="No",width=12,bg="gray",fg="white", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=12,bg="gray",fg="white", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=12,bg="gray",fg="white", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=12,bg="gray",fg="white", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        master.configure(bg="dark gray")  # Set background color
        master.title("Account")
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="HEALTHCARE CHATBOT", bg="dark gray", width="280", height="2", font=("Helvetica 13 bold"), fg="white")
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="LOGIN", bg="gray", height="1", width="15", font=("Helvetica",13), fg="white", command=self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="REGISTER", bg="gray", height="1", width="15",font=("Helvetica",13), fg="white", command=self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="dark gray", width = "250", height = "1",padx=10, pady=10, font=("Helvetica", 13), fg="white")
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="SHAIL BALA", bg="dark gray", width = "250", height = "1", font=("Calibri", 13), fg="white")
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="RITIK SHRIVASTAVA", bg="dark gray", width = "250", height = "1", font=("Calibri", 13), fg="white")
        self.lblTeam2.pack()
